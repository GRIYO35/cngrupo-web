...
<div className="timeline-container">
    <ul className="timeline">
        <li className="li-linea1" data-aos="fade-right">1991<br></br><div className="txt-linea1">EESS el Chango</div><hr className="linea-linea"></hr><br></br><img src={Linea1} alt="" className='linea1' /></li>
        ...
        <li className="li-linea1" data-aos="fade-right">2005<br></br><div className="txt-linea1">Sucursal Las Lajitas</div><hr className="linea-linea"></hr><br></br><img src={Linea2} alt="" className='linea1' /></li>

        <li className="li-linea5" data-aos="fade-left">2008<br></br><div className="txt-linea1">Sucursal Embarcación</div><hr className="linea-linea2"></hr><br></br><img src={Linea3} alt="" className='linea1' /></li>

        <li className="li-linea6i" data-aos="fade-right">2009<br></br><div className="txt-linea1">Planta Güemes</div><hr className="linea-linea"></hr><br></br><img src={Linea4} alt="" className='linea1' /></li>
        ...
        <li className="li-linea5" data-aos="fade-left">2022<br></br><div className="txt-linea1">CN Agro se transforma en NECA.<br></br>Galpón Embarcación NECA.</div><hr className="linea-linea2"></hr><br></br><img src={Linea5} alt="" className='linea1' /></li>
        
        <li className="li-linea6i" data-aos="fade-right">2023<br></br><div className="txt-linea1">Nueva EESS en Las Lajitas,<br></br>la estación del futuro</div><hr className="linea-linea"></hr><br></br><img src={Linea6} alt="" className='linea1' /></li>    
