...
<div className="timeline-container">
    <ul className="timeline">
        <li className="li-linea1" data-aos="fade-right">1991<br></br><div className="txt-linea1">EESS el Chango</div><hr className="linea-linea"></hr><br></br><img src={currentImage1} alt="" className='ImagenHistoria1' /></li>

        <li className="li-linea2i" data-aos="fade-left">1995<br></br><div className="txt-linea1">Combustibles del Norte</div><hr className="linea-linea2"></hr><br></br></li>
    
        <li className="li-linea3" data-aos="fade-right">1996<br></br><div className="txt-linea1">Mayorista Lubricantes</div><hr className="linea-linea"></hr></li>
          
        <li className="li-linea4i" data-aos="fade-left">2000<br></br><div className="txt-linea1">Distribución de fertilizantes</div><hr className="linea-linea2"></hr></li>

        <li className="li-linea2" data-aos="fade-right">2003<br></br><div className="txt-linea1">Gas del Norte</div><hr className="linea-linea"></hr></li>

        <li className="li-linea3i" data-aos="fade-left">2004<br></br><div className="txt-linea1"> CN Agro</div><hr className="linea-linea2"></hr></li>

        <li className="li-linea1" data-aos="fade-right">2005<br></br><div className="txt-linea1">Sucursal Las Lajitas</div><hr className="linea-linea"></hr><br></br><img src={currentImage2} alt="" className='ImagenHistoria1' /></li>

        <li className="li-linea5" data-aos="fade-left">2008<br></br><div className="txt-linea1">Sucursal Embarcación</div><hr className="linea-linea2"></hr><br></br><img src={currentImage3} alt="" className='ImagenHistoria1' /></li>

        <li className="li-linea6i" data-aos="fade-right">2009<br></br><div className="txt-linea1">Planta Güemes</div><hr className="linea-linea"></hr><br></br><img src={currentImage4} alt="" className='ImagenHistoria1' /></li>

        <li className="li-linea4i" data-aos="fade-left">2014<br></br><div className="txt-linea1">Lubricantes Chile</div><hr className="linea-linea2"></hr></li>

        <li className="li-linea2" data-aos="fade-right">2015<br></br><div className="txt-linea1">YPF Agro Las Lajitas</div><hr className="linea-linea"></hr></li>

        <li className="li-linea3i" data-aos="fade-left">2018<br></br><div className="txt-linea1">YPF Agro Embarcación</div><hr className="linea-linea2"></hr></li>

        <li className="li-linea4" data-aos="fade-right">2021<br></br><div className="txt-linea1">Galpón CN Agro en Las Lajitas</div><hr className="linea-linea"></hr></li>

        <li className="li-linea5" data-aos="fade-left">2022<br></br><div className="txt-linea1">CN Agro se transforma en NECA.<br></br>Galpón Embarcación NECA.</div><hr className="linea-linea2"></hr><br></br><img src={currentImage5} alt="" className='ImagenHistoria1' /></li>
        
        <li className="li-linea6i" data-aos="fade-right">2023<br></br><div className="txt-linea1">Nueva EESS en Las Lajitas,<br></br>la estación del futuro</div><hr className="linea-linea"></hr><br></br><img src={currentImage6} alt="" className='ImagenHistoria1' /></li>    
